...
* The ip byte array maximum length
*/
...
*/
QSC_EXPORT_API typedef enum qsc_ipinfo_address_types
{
	qsc_ipinfo_address_type_none = 0x00,			/*!< The address type is not set */
	qsc_ipinfo_address_type_ipv4 = 0x01,			/*!< The address type is IPv4 */
	qsc_ipinfo_address_type_ipv6 = 0x02,			/*!< The address type is IPv6 */
	qsc_ipinfo_address_type_unknown = 0xFF,			/*!< The address type is unknown */
...
*
* \return Returns the IP address type
*/
