...
\hypertarget{common_8h_source}{}\label{common_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSMP/QSMP/common.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/QSMP/QSMP/common.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ QSMP\_MASTER\_COMMON\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ QSMP\_MASTER\_COMMON\_H}}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00061\ \textcolor{preprocessor}{\#if\ defined(\_DLL)}}
\DoxyCodeLine{00062\ \textcolor{preprocessor}{\#\ \ \ define\ QSMP\_DLL\_API}}
\DoxyCodeLine{00063\ \textcolor{preprocessor}{\#endif}\textcolor{preprocessor}{}}
\DoxyCodeLine{00068\ \textcolor{preprocessor}{\#if\ defined(QSMP\_DLL\_API)}}
\DoxyCodeLine{00069\ \textcolor{preprocessor}{\#\ \ \ if\ defined(QSC\_SYSTEM\_COMPILER\_MSC)}}
\DoxyCodeLine{00070\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(QSMP\_DLL\_IMPORT)}}
\DoxyCodeLine{00071\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_declspec(dllimport)}}
\DoxyCodeLine{00072\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00073\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_declspec(dllexport)}}
\DoxyCodeLine{00074\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00075\ \textcolor{preprocessor}{\#\ \ \ elif\ defined(QSC\_SYSTEM\_COMPILER\_GCC)}}
\DoxyCodeLine{00076\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(QSMP\_DLL\_IMPORT)}}
\DoxyCodeLine{00077\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_attribute\_\_((dllimport))}}
\DoxyCodeLine{00078\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00079\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_attribute\_\_((dllexport))}}
\DoxyCodeLine{00080\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00081\ \textcolor{preprocessor}{\#\ \ \ else}}
\DoxyCodeLine{00082\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(\_\_SUNPRO\_C)}}
\DoxyCodeLine{00083\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ if\ !defined(\_\_GNU\_C\_\_)}}
\DoxyCodeLine{00084\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_attribute\_\_\ (visibility(\_\_global))}}
\DoxyCodeLine{00085\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ else}}
\DoxyCodeLine{00086\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_attribute\_\_\ \_\_global}}
\DoxyCodeLine{00087\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00088\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ elif\ defined(\_MSG\_VER)}}
\DoxyCodeLine{00089\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ extern\ \_\_declspec(dllexport)}}
\DoxyCodeLine{00090\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00091\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ QSMP\_EXPORT\_API\ \_\_attribute\_\_\ ((visibility\ ("{}default"{})))}}
...
\DoxyCodeLine{00095\ \textcolor{preprocessor}{\#\ \ \ define\ QSMP\_EXPORT\_API}}
